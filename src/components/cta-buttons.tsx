...
function NeonButton({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <Link
      href={href}
      className="neon-button inline-flex items-center justify-center px-4 py-2 md:px-6 md:py-2.5
                 text-[11px] md:text-sm font-sans font-semibold text-hero-foreground"
