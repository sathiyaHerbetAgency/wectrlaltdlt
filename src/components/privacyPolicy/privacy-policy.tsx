    ...
    <section className="space-y-4 max-w-[1140px] mx-auto font-[inter] px-4 py-8 md:py-12">    
      <section className="space-y-4 ">
        ...
        <div className="space-y-3 text-muted-foreground leading-relaxed">
          ...
          <div>
            <h3 className="font-semibold text-foreground">1.2. Payment Information</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-foreground">1.3. Automatically Collected Information</h3>
            <p>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold text-foreground">Information Usage</h2>
        <div className="space-y-3 text-muted-foreground leading-relaxed">
          <div>
            <h3 className="font-semibold text-foreground">2.1. Festival Services</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-foreground">2.2. Communication</h3>
            <p>
          ...
          <div>
            <h3 className="font-semibold text-foreground">2.3. Payment Processing</h3>
            <p>Your payment information is used solely for processing ticket purchases and related transactions.</p>
          </div>
          <div>
            <h3 className="font-semibold text-foreground">2.4. Analytics</h3>
            <p>
      ...
      <section className="space-y-4 pt-4 border-t border-border">
        ...
        <p className="text-xs text-muted-foreground">Last Updated: 21 October 2025</p>
      </section>
    </section>
    </div>
